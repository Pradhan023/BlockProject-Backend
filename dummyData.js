const BollywoodData = [
    ...
    const EducationData = [
        {
            id: 0,
            heading: "MICA to introduce new course on Media Platforms Analytics",
            image: "https://images.indianexpress.com/2023/10/MICA-2-1.jpg?resize=720,405?w=640",
            description:"The new programme will be launched in partnership with media insights and analytics firm, Ormax Media.",
            contentDesc:"MICA will introduce a new programme on Media Platforms Analytics. The new programme seeks to equip students with an understanding of multiple aspects of media analytics, audience engagement and how to measure and analyse data to build a media platform. The course will be conducted by media professionals at Ormax Media and will cover three domains – streaming, theatrical and television. “Around 50 second-year students from the Media and Entertainment Management (MEM) specialisation will be exposed to a 360-degree approach to planning, applicable to multiple functions like content, marketing, revenue, distribution, engagement, and more, across the three domains mentioned above,” an official statement issued in this regard said.",
            category:"Education",
            Anish: "Pradhan"
        },
        {
            id: 1,
            heading: "‘Medical colleges doubled in last 9 years’: Mansukh Mandaviya",
            image: "https://images.indianexpress.com/2023/10/Mansukh-Mandaviya.jpg?w=640",
            description:"The minister claimed that the number of MBBS seats in the country has increased from 50,000 in 2014 to 1,07,000 till now.",
            contentDesc:"Union Health and Family Welfare Minister Mansukh Mandaviya claimed that the number of medical colleges in the country has doubled in the past nine years. He also notified that the central government is building one critical care unit in every district in the nation.“In the last nine years, the number of medical colleges has doubled in the country. A total of 1,70,000 Health and Wellness Centres have been created across India. We are also building one Critical Care unit in every district in the country,” he said in an address at NEIGRIHMS, Shillong.",
            category:"Education",
            Anish: "Pradhan"
        },
        {
            id: 2,
            heading: "UGC revises fellowship amounts for JRF, post doctoral, other schemes",
            image: "https://images.indianexpress.com/2023/10/ugc-image-1.jpg?resize=720,405?w=640",
            description:"UGC Fellowship: The revised rates of fellowship will be applicable with effect from January 1, 2023 for the existing beneficiaries only.",
            contentDesc:"The University Grants Commission (UGC) has revised the fellowship amounts for the Junior Research Fellowship, Senior Research Fellowship in science, humanities and social sciences, Savitribai Jyotirao Phule Fellowship for Single Girl Child, Dr DS Kothari Post Doctoral Fellowship (DSKPDF) and post-doctoral fellowship for women. The enhanced rates of fellowship in the designated UGC schemes will be applicable to the existing beneficiaries only, a UGC statement said. While the Junior Research Fellowship amount has been increased from Rs 31,000 per month for two years to Rs 37,000 per month, the Senior Research Fellowship amount has been increased to Rs 42,000 per month for the remaining period from Rs 35,000.",
            category:"Education",
            Anish: "Pradhan"
        },
        {
            id: 3,
            heading: "NEET UG: Top medical colleges in Rajasthan, MBBS college rankings",
            image: "https://images.indianexpress.com/2023/10/neet-ug-mbbs-1.jpg?w=640",
            description:"NEET UG 2024: AIIMS Jodhpur is the top medical college in the state and has been ranked in the 13th position in the NIRF 2023.",
            contentDesc:"NEET UG 2024: Two medical colleges from Rajasthan have been ranked in the Education Ministry’s National Institutional Ranking Framework (NIRF) 2023. The All India Institute of Medical Sciences (AIIMS) Jodhpur and Sawai Man Singh Medical College are the two medical colleges from Rajasthan that made it to the list of NIRF 2023 medical college rankings. AIIMS Jodhpur is the top medical college in the state and has been ranked at the 13th position in the NIRF 2023 medical college rankings. The Sawai Man Singh Medical College ranks 46th in the NIRF 2023 medical college rankings.",
            category:"Education",
            Anish: "Pradhan"
        },
        {
        ...
        {
            id: 5,
            heading: "JEE Main: NIT-Puducherry CSE cut-offs for BTech admission in past 5 years",
            image: "https://images.indianexpress.com/2023/10/nit-puducherry-1.jpg?w=640",
            description:"EE Main 2024: For admission to an NIT, 50 per cent of the seats are reserved for students from within the state in which the NIT is located and the remaining seats are reserved for the ones from other states across the country.",
            contentDesc:"JEE Main 2024: The National Institute of Technology (NIT) Puducherry has been admitting candidates to its undergraduate engineering programmes based on the Joint Entrance Examination (JEE) Main score. NIT Puducherry offers undergraduate engineering, postgraduate engineering degrees and PhD programmes. Puducherry offers BTech in subjects including civil engineering, computer science and engineering, electronics and communication engineering, electrical and electronics engineering and mechanical engineering. Joint Seat Allocation Authority (JoSAA) conducts separate counselling processes for admission to the NITs. Admission in BTech programmes at the NIT Puducherry is made on the basis of the performance in JEE for the Indian nationals. Admissions to the 50 per cent seats are made among the students of the union territory and the remaining 50 per cent seats are made on the basis of an all India ranking of the aspiring applicants. ",
            category:"Education",
            Anish: "Pradhan"
        },
        {
            id: 6,
            heading: "harmendra Pradhan to launch ‘Apna Chandrayaan’ programme to develop scientific temper among school students",
            image: "https://images.indianexpress.com/2023/10/dharmendra-pradhan-1-1.jpg?resize=720,405?w=640",
            description:"Chandrayaan 3 Mission: The ISRO Chairman and Secretary, Department of Space, will also be present at the launch of the Apna Chandrayaan programme today.",
            contentDesc:"The Union Education Minister Dharmendra Pradhan will today launch the ‘Apna Chandrayaan programme’. As part of the programme, the Education Minister will be launching a web portal with activity-based support materials including colouring books, online quizzes and jigsaw puzzles on India’s Chandrayaan mission. These activity-based support materials for school students have been developed by the NCERT. As many as 10 special modules on Chandrayaan-3 will also be launched to offer a comprehensive overview of the moon mission’s various facets including scientific, technological and social aspects. Dr Sreedhara Panicker Somanath, ISRO Chairman and Secretary, Department of Space, will be present as the guest of honor at the launch of the programme today.",
            category:"Education",
            Anish: "Pradhan"
        },
        {
            id: 7,
            heading: "IGNOU December 2023 TEE exam registration deadline for online programmes extended again",
            image: "https://images.indianexpress.com/2023/10/IGNOU-1-1.jpg?w=640",
            description:"IGNOU December 2023 TEE Application: IGNOU will also allow registrations for December 2023 TEE after October 22 with the payment of a late fee.",
            contentDesc:"The Indira Gandhi National Open University (IGNOU) has extended the last date for the December 2023 term-end examination (TEE) online registration. The last date to register for IGNOU December TEE 2023 exam for online and online distance learning (ODL) programmes without the payment of late fee is October 22, 2023. Earlier, the last date to register for IGNOU December TEE 2023 exam was October 15. “The last date for submission of Online Examination Form for the Term-end Examination, December, 2023 without late fee has been extended till 22nd October 2023 for ODL and OL(Online) Programmes,” an IGNOU statement said.",
            category:"Education",
            Anish: "Pradhan"
        },
        {
            id: 8,
            heading: "Why do students in Kota continue to opt for dummy schools? Is it dual burden?",
            image: "https://images.indianexpress.com/2023/10/Kota-Dummy-schools.jpg?w=640",
            description:"In Kota, posters of different dummy schools along with their rates are splashed across the city. Ranging from Rs 15,000 to Rs 50,000 dummy schools charge different rates depending on the boards they are affiliated with.",
            contentDesc:"Riddhima is enrolled as a student of class 11 in a school in her hometown Gaya in Bihar. But she lives miles away in the coaching hub of Kota in Rajasthan where she is preparing for JEE Advanced, the entrance exam for the IITs. She is not alone. Scores of students preparing for engineering and medical entrance exams prefer to take admission to dummy schools so that they can focus solely on their preparation for the competitive exams. They do not need to attend classes and can straightaway appear for board exams.",
            category:"Education",
            Anish: "Pradhan"
        },
        {
            id: 9,
            heading: "These are the recent changes in Canada’s student visa policy",
            image: "https://images.indianexpress.com/2023/10/Study-Abroad-1.jpg?w=640",
            description:"While the two governments have assured that Indian students in Canada won't get affected due to the ongoing diplomatic spat between the two countries, here's a look at what other changes have been brought in Canada's visa policies in the past five years.",
            contentDesc:"Canada has long been a popular destination for Indian students seeking to build a better life for themselves and their families. According to rankings by the Times Higher Education and QS rankings, Canadian universities consistently stand tall among the world’s top academic institutions. However, the recent diplomatic spat between India and Canada has become a cause of worry for Indian students aspiring to study in Canada. Over the past few years, the Canadian government has made several significant changes to its visa policies and immigration programmes. Most new study permits are now being processed within the 60-day service standard. In 2018, Canada introduced the Student Direct Stream (SDS) programme, streamlining the study permit application process for students from select countries, including India, China, the Philippines, and Vietnam. SDS applicants were required to meet specific eligibility criteria, including language proficiency and financial requirements.",
            category:"Education",
            Anish: "Pradhan"
        },
        {
            id: 10,
            heading: "NLU Delhi launches Joint Masters in IP Law and Management; signs tripartite MoU",
            image: "https://images.indianexpress.com/2023/10/MoU-Signing.jpeg?w=640",
            description:"The one-year global programme will be offered in dual track (i.e. law and non-law background) to students from India, South Asia and to other foreign nationals.",
            contentDesc:"The National Law University (NLU), Delhi has announced the signing of the tripartite MoU between National Law University Delhi with the World Intellectual Property Organisation (WIPO) and Office of Controller General of Patents Designs and Trade Marks (CGPDTM -Indian IP Office), Department for Promotion of Industry and Internal Trade (DPIIT), Ministry of Commerce and Industry, Government of India for launching the Joint Masters/LLM in IP Law and Management from August 2024. The one-year global programme will be offered in dual track (i.e. law and non-law background) to students from India, South Asia and to other foreign nationals. This MoU was signed by Vice Chancellor Prof (Dr) G. S. Bajpai with Daren Tang, Director General, WIPO and Prof (Dr) Unnat Pandit, Controller General, IP Office, in the presence of the Union Minister for Commerce and Industry, Piyush Goyal and the Minister of State, Som Prakash, Ministry of Commerce and Industry, Government of India, Secretary and Joint Secretary, DPIIT and other officials of the DPIIT and WIPO at Vanijya Bhavan, New Delhi.",
            category:"Education",
            Anish: "Pradhan"
        },
        {
            id: 11,
            heading: "World Students’ Day 2023: Why is October 15 celebrated as Students’ Day?",
            image: "https://images.indianexpress.com/2023/10/abdul-kalam-1.jpg?w=640",
            description:"World Students' Day 2023: Dr Kalam, a great teacher, an eminent scientist and a great statesman, served as the 11th Indian President from 2002 to 2007. ",
            contentDesc:"India observes World Students’ Day on October 15. It is celebrated to mark the birth anniversary of the former President of India Dr APJ Abdul Kalam. Dr Kalam, a great teacher, an eminent scientist and a great statesman, served as the 11th Indian President from 2002 to 2007. On the eve of World Students’ Day 2023, we remember how the former President always encouraged students across the country and abroad to dream big and never be afraid of failure. The President always wanted to be remembered as a teacher. After completing his tenure as the 11th President of India, Dr Kalam went back to teaching. ",
            category:"Education",
            Anish: "Pradhan"
        },
        {
            id: 12,
            heading: "IIT-Kharagpur’s First Batch: ‘Our classes were held where freedom fighters were locked up’",
            image: "https://images.indianexpress.com/2023/10/IIT-Kharagpur.jpg?w=640",
            description:"An electrical engineering (1951-55) alumnus, Narasimhan Venkatesan Patel (former member of the Railway Board) shares some interesting anecdotes about the faculty and how IIT-Kharagpur took special tutorials of students who appeared in Class 12 exams from different boards or syllabi.",
            contentDesc:"(In this six-part series, indianexpress.com talks to alumni from the first batch of first-generation Indian Institutes of Technology (IIT). They tell us about the admission process back then, academic pressure, campus life, and how they bonded with their fellow students and faculty). The Indian Institute of Technology, Kharagpur (IIT Kharagpur) was established in 1951 and is the oldest among all the IITs in the country. As the institute was set up in the Hijli detention camp of West Bengal, it has a link with the freedom fighters of India. An electrical engineering (1951-55) alumnus, Narasimhan Venkatesan Patel (former member of the Railway Board) shares some interesting anecdotes about the faculty and how IIT-Kharagpur took special tutorials of students who appeared in Class 12 exams from different boards or syllabi. “We mostly had classes in the old Hijlee Central Jail building in the first two years. A big hangar inside the compound served as the workshop. Our staff, some of whom had served in the prison administration as jailors, mentioned that our classrooms were the rooms where prisoners (many great freedom fighters) were locked up, and some were tortured and later died.",
            category:"Education",
            Anish: "Pradhan"
        },
        {
            id: 13,
            heading: "Supreme Court, IIT-Madras sign MoU to bring digital transformation of judiciary through AI",
            image: "https://images.indianexpress.com/2023/10/IIT-Madras.jpg?w=640",
            description:"Through this partnership, IIT Madras will utilise artificial intelligence (AI) and emerging technologies in day-to-day proceedings of the Supreme Court.",
            contentDesc:"",
            category:"Education",
            Anish: "Pradhan"
        },
        {
            id: 14,
            heading: "5 common mistakes to avoid while preparing for CAT",
            image: "https://akm-img-a-in.tosshub.com/indiatoday/images/story/202310/5-common-mistakes-to-avoid-while-preparing-for-cat-163527536-16x9.jpg?VersionId=YjgxKmtsuZyiGbaJf3dWyNdi9TrLRxER&size=690:388",
            description:"Preparing for the CAT (Common Admission Test) can be a challenging task, and avoiding common mistakes is crucial to achieving success. Here are five common mistakes that aspirants should avoid while preparing for CAT:",
            contentDesc:"As the CAT 2023 exam date looms closer, aspirants across India are gearing up for one of the most fiercely competitive exams in the country. The Common Admission Test (CAT) serves as the doorway to prestigious management institutes, and understandably, the pressure is immense. The high-pressure situation of preparing for the CAT exam often makes candidates nervous and stressed, thus, negatively affecting their chances of success. Here are five typical mistakes shared by Gautam Puri. Vice Chairman & MD, Career Launcher that CAT aspirants often make during their preparation and a few strategies to help prevent them.1. NEGLECTING THE CAT SYLLABUS 2. OVERLOOKING REGULAR REVISION  3. IGNORING MOCK TESTS  4. INADEQUATE TIME MANAGEMENT AND PREPARATION PROCESS 5. IMBALANCED FOCUS ON WEAK AREAS",
            category:"Education",
            Anish: "Pradhan"
        },
    ] 
    ...
    module.exports ={BollywoodData,HollywoodData,TechnologyData,FitnessData,EducationData};  //exporting the data to controller file for the logic